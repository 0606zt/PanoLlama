...
class VQModel(nn.Module):
    ...
    def encode_code(self, image):
        _, _, min_encoding_indices = self.encode(image)[-1]
        min_encoding_indices = min_encoding_indices.view(-1, 32, 32)
...
class VectorQuantizer(nn.Module):
    ...
    def forward(self, z):
        ...
        min_encoding_indices = torch.argmin(d, dim=1)  # indices are tokens
